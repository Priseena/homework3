...
class Calculation:
    ...
    def __init__(self, a: Decimal, b: Decimal,
        ...
        # This allows for flexible assignment of any function that matches this signature
        # (like add, subtract, etc.)
        self.operation = operation

    # Static method to create a new instance of Calculation
    # This method provides an alternative constructor that can be used without
    # instantiating the class directly
    @staticmethod
    def create(a: Decimal, b: Decimal,
               operation: Callable[[Decimal, Decimal], Decimal]):
    ...
    def perform(self) -> Decimal:
        ...
        # The operation (e.g., add, subtract) is called with the operands (a and b)
    ...
    def __repr__(self):
        ...
        # This method makes it easier to understand what the Calculation object represents
        # when printed or logged. The operation.__name__ attribute is used to get the
        # function's name for a more readable output.
