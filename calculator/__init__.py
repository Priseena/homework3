"""
This module contains the Calculator class for basic arithmetic operations.
"""
...
class Calculator:
    ...
    def add(a: Decimal, b: Decimal) -> Decimal:
        """
        Perform addition by delegating to the _perform_operation method
    ...
    def subtract(a: Decimal, b: Decimal) -> Decimal:
        """
        Perform subtraction by delegating to the _perform_operation method
    ...
    def multiply(a: Decimal, b: Decimal) -> Decimal:
        """
        Perform multiplication by delegating to the _perform_operation method
        with the multiply operation.
        """
    ...
    def divide(a: Decimal, b: Decimal) -> Decimal:
        """
        Perform division by delegating to the _perform_operation method
